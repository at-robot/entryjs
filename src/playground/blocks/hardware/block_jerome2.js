...
Entry.jerome2.setLanguage = function() {
    return {
        ko: {
            template: {
...
Entry.jerome2.getBlocks = function() {
    return {
        ...
        arduino_ext_get_ultrasonic_value: {
            ...
            func(sprite, script) {
                ...
                Entry.hw.sendQueue.GET[Entry.jerome2.sensorTypes.ULTRASONIC] = {
                    port: [port1, port2],
        ...
        arduino_ext_get_digital: {
            ...
            func(sprite, script) {
                ...
                if (name === 'ArduinoExt' || name === 'ArduinoNano') {
                    ...
                    Entry.hw.sendQueue.GET[Entry.jerome2.sensorTypes.DIGITAL] = {
                        port,
                        time: new Date().getTime(),
                    };
        ...
        arduino_ext_toggle_led: {
            ...
            func(sprite, script) {
                ...
                if (Entry.jerome2.highList.indexOf(value) > -1) {
                    value = 255;
                } else if (Entry.jerome2.lowList.indexOf(value) > -1) {
                    value = 0;
                } else {
                    throw new Error();
                }
                ...
                Entry.hw.sendQueue.SET[port] = {
                    type: Entry.jerome2.sensorTypes.DIGITAL,
                    data: value,
                    time: new Date().getTime(),
                };
        ...
        arduino_ext_digital_pwm: {
            ...
            func(sprite, script) {
                ...
                Entry.hw.sendQueue.SET[port] = {
                    type: Entry.jerome2.sensorTypes.PWM,
                    data: value,
                    time: new Date().getTime(),
                };
                return script.callReturn();
            ...
            func(sprite, script) {
                ...
                if (!script.isStart) {
                    ...
                    if (!Entry.Utils.isNumber(note)) {
                        note = Entry.jerome2.toneTable[note];
                    }
                    ...
                    if (duration === 0) {
                        sq.SET[port] = {
                            type: Entry.jerome2.sensorTypes.TONE,
                            data: 0,
                            time: new Date().getTime(),
                        };
                        return script.callReturn();
                    ...
                    if (note != 0) {
                        value = Entry.jerome2.toneMap[note][octave];
                    }
        ...
        arduino_ext_set_servo: {
            ...
            func(sprite, script) {
                ...
                sq.SET[port] = {
                    type: Entry.jerome2.sensorTypes.SERVO_PIN,
                    data: value,
                    time: new Date().getTime(),
                };
